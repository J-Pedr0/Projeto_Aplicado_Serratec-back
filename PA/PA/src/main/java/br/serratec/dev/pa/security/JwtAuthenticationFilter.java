...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	   ...
	   protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		   ...
		   CustomUsernamePasswordAuthenticationToken auth = (CustomUsernamePasswordAuthenticationToken) authResult;
		   UserTokenDTO userToken = auth.getUserTokenDTO();
		   
	       String username = userToken.getCorporativeEmail();
	       String token = jwtUtil.generateToken(username, userToken);

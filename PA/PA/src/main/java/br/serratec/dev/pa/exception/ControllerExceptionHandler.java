...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handlerPatrimonioException(PatrimonioException ex) {
		return ResponseEntity.unprocessableEntity().body(ex.getMessage());
	}

    @ExceptionHandler(NumeroSerieException.class)
	public ResponseEntity<Object> handlerNumeroSerieException(NumeroSerieException ex) {
		return ResponseEntity.unprocessableEntity().body(ex.getMessage());
	}
	...
	public ResponseEntity<Object> handleDataEmprestimoAnteriorException(DataException ex) {
		List<ErroCampo> erros = new ArrayList<>();
